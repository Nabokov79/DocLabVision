...
(
    id                           BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    left_title_id         BIGINT                                 NOT NULL,
    CONSTRAINT pk_protocolTemplate PRIMARY KEY (id),
    CONSTRAINT FK_PROTOCOL_TEMPLATES_ON_PAGE_TITLES FOREIGN KEY (left_title_id) REFERENCES page_titles (id)
);
...
CREATE TABLE IF NOT EXISTS PROTOCOL_TEMPLATES_TABLE_HEADER_TEMPLATES
(
    protocol_template_id BIGINT,
    table_header_template_id      BIGINT,
    CONSTRAINT pk_protocol_templates_of_table_header_templates
    PRIMARY KEY (protocol_template_id, table_header_template_id)
);
...
CREATE TABLE IF NOT EXISTS REPORT_PROTOCOL_TEMPLATES_SUBSECTION_TEMPLATES
(
    report_protocol_template_id BIGINT,
    subsections_template_id      BIGINT,
    CONSTRAINT pk_report_protocol_templates_of_subsections_templates
    PRIMARY KEY (report_protocol_template_id, subsections_template_id)
);

CREATE TABLE IF NOT EXISTS REPORT_PROTOCOL_TEMPLATES_TABLE_HEADER_TEMPLATES
(
    report_protocol_template_id BIGINT,
    table_header_template_id      BIGINT,
    CONSTRAINT pk_report_protocol_templates_of_table_header_templates
        PRIMARY KEY (report_protocol_template_id, table_header_template_id)
);
...
(
    ...
    CONSTRAINT FK_PROTOCOL_TEMPLATES_ON_PAGE_TITLES FOREIGN KEY (page_title_id) REFERENCES page_titles (id)
);
...
CREATE TABLE IF NOT EXISTS REPORT_TEMPLATES_APPENDICES
(
    report_template_id BIGINT,
    appendices_id      BIGINT,
    CONSTRAINT pk_report_templates_of_appendices PRIMARY KEY (report_template_id, appendices_id)
);
...
(
    ...
    CONSTRAINT FK_PROTOCOL_TEMPLATES_ON_REPORT_TEMPLATES FOREIGN KEY (report_template_id)
                                                         REFERENCES report_templates (id),
    CONSTRAINT FK_PROTOCOL_TEMPLATES_ON_PROTOCOL_TEMPLATES FOREIGN KEY (protocol_template_id)
