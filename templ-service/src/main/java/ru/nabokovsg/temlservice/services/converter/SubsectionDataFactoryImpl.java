...
public class SubsectionDataFactoryImpl implements SubsectionDataFactory {
    ...
    @Override
    public List<SubsectionDataTemplate> createByDocumentationData(DataType type, List<DocumentationDto> documentations) {
        switch (type) {
    ...
    @Override
    public List<SubsectionDataTemplate> createByDivisionData(DataType divisionType, Long divisionId, String divisionName) {
        switch (divisionType) {
