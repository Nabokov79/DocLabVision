...
(
    ...
    CONSTRAINT UQ_OBJECTS_TYPES UNIQUE (object, volume, orientation)
);

CREATE TABLE IF NOT EXISTS PLOT_OF_OBJECTS
(
    id        BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    plot_name VARCHAR                                 NOT NULL,
    CONSTRAINT pk_plotOfObject PRIMARY KEY (id),
    CONSTRAINT UQ_PLOT_OF_OBJECTS UNIQUE (plot_name)
);

CREATE TABLE IF NOT EXISTS OBJECTS_TYPES_PLOT_OF_OBJECTS
(
    object_type_id    BIGINT,
    plot_of_object_id BIGINT,
    CONSTRAINT pk_object_types_of_plot_of_objects PRIMARY KEY (object_type_id, plot_of_object_id)
);
...
(
    ...
    CONSTRAINT FK_SURVEY_OBJECTS_ON_OBJECTS_TYPES FOREIGN KEY (objects_type_id) REFERENCES objects_types (id),
...
(
    id                           BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    sequential_subsection_number VARCHAR                                 NOT NULL,
...
(
    ...
    CONSTRAINT UQ_PLACES UNIQUE (place_name)
);
...
CREATE TABLE IF NOT EXISTS SUB_ELEMENTS_PLACES
(
    sub_element_id BIGINT,
    place_id       BIGINT,
    CONSTRAINT pk_subElements_of_places PRIMARY KEY (sub_element_id, place_id)
);
