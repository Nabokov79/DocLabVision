...
CREATE TABLE IF NOT EXISTS PAGE_HEADER_TEMPLATES
(
    id                      BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    ...
    CONSTRAINT pk_headerDocumentTemplate PRIMARY KEY (id)
);

CREATE TABLE IF NOT EXISTS PAGE_TITLE_TEMPLATES
(
    id                           BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    page_header_template_id      BIGINT                                  NOT NULL,
    ...
    CONSTRAINT FK_PAGE_TITLE_TEMPLATES_ON_PAGE_HEADER_TEMPLATES FOREIGN KEY (page_header_template_id)
        REFERENCES page_header_templates (id)
);
...
(
    ...
    sequential_protocol_number INTEGER,
    ...
    CONSTRAINT FK_PROTOCOL_TEMPLATES_ON_CONCLUSIONS_TEMPLATES
        FOREIGN KEY (conclusions_template_id)
            REFERENCES conclusions_templates (id),
    CONSTRAINT FK_PROTOCOL_TEMPLATES_ON_PAGE_HEADER_TEMPLATES
        FOREIGN KEY (page_header_id)
            REFERENCES page_header_templates (id)
);
