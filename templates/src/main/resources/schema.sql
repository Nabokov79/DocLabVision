...
CREATE TABLE IF NOT EXISTS SURVEY_OBJECT_PASSPORT_DATA_TEMPLATES
(
    id                BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    ...
    CONSTRAINT pk_surveyObjectPassportDataTemplate PRIMARY KEY (id),
    CONSTRAINT UQ_SURVEY_OBJECT_PASSPORT_DATA_TEMPLATES UNIQUE (sequential_number, data_name)
);
...
(
    ...
    CONSTRAINT UQ_RECOMMENDATIONS_TEMPLATES UNIQUE (recommendation_text)
);
...
(
    ...
    sequential_table_number INTEGER,
    table_name              VARCHAR,
...
CREATE TABLE IF NOT EXISTS SUBSECTION_TEMPLATES_PASSPORT_DATA_TEMPLATES
(
    id                     BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    subsection_template_id BIGINT,
    passport_data_id       BIGINT,
    CONSTRAINT pk_subsection_templates_of_passport_data_templates PRIMARY KEY (subsection_template_id, passport_data_id)
);

CREATE TABLE IF NOT EXISTS SUBSECTION_TEMPLATES_SUBSECTION_DATA_TEMPLATES
(
    subsection_template_id      BIGINT,
    subsection_data_template_id BIGINT,
    CONSTRAINT pk_subsection_templates_of_subsection_data_templates
        PRIMARY KEY (subsection_template_id, subsection_data_template_id)
);

CREATE TABLE IF NOT EXISTS SUBSECTION_TEMPLATES_TABLE_TEMPLATES
(
    subsection_template_id BIGINT,
    table_template_id      BIGINT,
    CONSTRAINT pk_subsection_templates_table_templates PRIMARY KEY (subsection_template_id, table_template_id)
);
...
(
    subsection_template_id BIGINT,
    table_template_id      BIGINT,
    CONSTRAINT pk_subsection_templates_of_table_templates PRIMARY KEY (subsection_template_id, table_template_id)
);
...
(
    ...
    object_string                VARCHAR                                 NOT NULL,
    installation_location_string VARCHAR                                 NOT NULL,
    address_string               VARCHAR                                 NOT NULL,
    signature_string             VARCHAR                                 NOT NULL,
...
CREATE TABLE IF NOT EXISTS PROTOCOL_TEMPLATES_APPENDICES_TEMPLATES
(
    protocol_template_id BIGINT,
    appendices_id        BIGINT,
    CONSTRAINT pk_protocol_templates_of_appendices_templates PRIMARY KEY (protocol_template_id, appendices_id)
);
...
CREATE TABLE IF NOT EXISTS SECTION_TEMPLATES_PASSPORT_DATA_TEMPLATES
(
    id                  BIGINT GENERATED BY DEFAULT AS IDENTITY NOT NULL,
    section_template_id BIGINT,
    passport_data_id    BIGINT,
    CONSTRAINT pk_section_templates_of_passport_data_templates PRIMARY KEY (section_template_id, passport_data_id)
);
...
(
    ...
    CONSTRAINT pk_section_templates_of_report_protocol_templates PRIMARY KEY (section_template_id,
                                                                              report_protocol_template_id)
);
