...
(
    ...
    CONSTRAINT UQ_OBJECT_TYPES UNIQUE (object_name, volume, orientation)
);
...
(
    ...
    CONSTRAINT FK_DOCUMENTATIONS_ON_OBJECT_TYPES FOREIGN KEY (objects_type_id) REFERENCES object_types (id)
);

CREATE TABLE IF NOT EXISTS DOCUMENTATIONS_OBJECT_TYPES
(
    documentation_id BIGINT,
    object_type_id   BIGINT,
    CONSTRAINT pk_documentations_of_object_types PRIMARY KEY (documentation_id, object_type_id)
);
...
(
    ...
    CONSTRAINT FK_NORMS_ON_OBJECT_TYPES FOREIGN KEY (objects_type_id) REFERENCES object_types (id)
);
...
(
    ...
    CONSTRAINT UQ_OBJECT_PASSPORT_DATA_TEMPLATES UNIQUE (objects_type_id, sequential_subsection_number, data_name),
    CONSTRAINT FK_OBJECT_PASSPORT_DATA_TEMPLATES_ON_OBJECT_TYPES
        FOREIGN KEY (objects_type_id) REFERENCES object_types (id)
);

CREATE TABLE IF NOT EXISTS OBJECT_PASSPORT_DATA_TEMPLATES_OBJECT_TYPES
(
    object_passport_data_id BIGINT,
    object_type_id          BIGINT,
    CONSTRAINT pk_object_passport_data_templates_of_object_types PRIMARY KEY (object_passport_data_id, object_type_id)
);
...
(
    ...
    CONSTRAINT FK_REPAIR_METHODS_ON_OBJECT_TYPES FOREIGN KEY (object_type_id) REFERENCES object_types (id)
);
...
(
    ...
    CONSTRAINT FK_ELEMENTS_ON_OBJECT_TYPES FOREIGN KEY (objects_type_id) REFERENCES object_types (id)
);
...
(
    ...
    CONSTRAINT FK_NORMS_ON_OBJECT_TYPES FOREIGN KEY (object_type_id) REFERENCES object_types (id)
);
...
CREATE TABLE IF NOT EXISTS OBJECTS_TYPE_DATA_NORMS
(
    objects_type_data_id BIGINT,
    norm_id              BIGINT,
    CONSTRAINT pk_objects_type_data_of_norms PRIMARY KEY (objects_type_data_id, norm_id)
);
...
CREATE TABLE IF NOT EXISTS OBJECTS_TYPE_DATA_REPAIR_METHODS
(
    objects_type_data_id BIGINT,
    repair_method_id     BIGINT,
    CONSTRAINT pk_objects_type_data_of_repair_methods PRIMARY KEY (objects_type_data_id, repair_method_id)
);
